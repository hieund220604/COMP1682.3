...
class _DebtReminderDialogState extends State<DebtReminderDialog>
  ...
  Future<void> _generate() async {
    ...
    try {
      ...
      final message = await aiProvider.generateDebtReminder(
      ...
      if (mounted) {
        setState(() {
          ...
          _generatedStyleLabel = AiProvider.debtReminderStyles[_selectedStyle];
          _isGenerating = false;
        });
      ...
      if (mounted) {
        setState(() {
          _error = 'Failed to generate message: $e';
          _isGenerating = false;
        });
      }
    }
  ...
  Future<void> _sendToChat() async {
    ...
    try {
      await AppServices.dio.post(
        ApiConstants.chatMessages(widget.groupId),
        data: {'content': _generatedMessage!, 'messageType': 'TEXT'},
      );
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Successfully sent debt reminder to group chat!'),
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Send reminder to ${widget.debtorName}',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            '${widget.transfers.length} pending payments',
                            style: textTheme.bodySmall?.copyWith(
                              color: scheme.onSurfaceVariant,
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: AiProvider.debtReminderStyles.entries
                    .map((entry) {
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Debt reminder message — ${_generatedStyleLabel ?? ''}',
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: FilledButton.icon(
                          ...
                          label: Text(
                              _isSending ? 'Sending...' : 'Send to Group Chat'),
                          style: FilledButton.styleFrom(
                            padding:
                                const EdgeInsets.symmetric(vertical: 12),
                            shape: RoundedRectangleBorder(
